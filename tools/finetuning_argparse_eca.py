...
def get_argparse():
    ...
    # Required parameters
    parser.add_argument("--ten_fold", default=False,type=bool,
                        help="whether use ten fold cross validation or not")
    ...
    parser.add_argument("--split_times", default=5, type=int,
                        help="Batch size per GPU/CPU for training.")
    parser.add_argument("--Gpu_num", default=0, type=int,
                        help="Batch size per GPU/CPU for training.")
    parser.add_argument("--data_type", default='sti', type=str,
                        help="ch or en, sti, merge_ch")
    parser.add_argument("--model_encdec", default='bert2gru', type=str, 
                        help="Model type selected in the list: 'bert2crf', 'bert2gru', 'bert2softmax' ")
    ...
    parser.add_argument("--label_embedding_size", default=50, type=int, 
                        help="")
    parser.add_argument("--dropout", default=1.0, type=float, help=".")
    ...
    parser.add_argument("--label_size", default=13, type=int,
                        help="the number of label ['O', 'B', 'I'] ")
    parser.add_argument('--emotion_label_size', default=3, type=int,
                        help = "the number of emotion span labels")
    parser.add_argument("--cause_label_size", default=3, type = int,
                        help = "the number of cause span labels")
    ...
    parser.add_argument("--output_dir", default=os.path.join(path,'out_put_'), type=str, 
    ...
    parser.add_argument("--train_max_seq_length", default=150, type=int,
                        help="The maximum total input sequence length after tokenization. Sequences longer "
                             "than this will be truncated, sequences shorter will be padded.", )
    parser.add_argument("--eval_max_seq_length", default=150, type=int,
                        help="The maximum total input sequence length after tokenization. Sequences longer "
                             "than this will be truncated, sequences shorter will be padded.", )
    ...
    parser.add_argument("--evaluate_during_train", default=True, type=bool,
